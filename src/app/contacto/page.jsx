...
const Contacto = (props) => {
  return (
    <div id="contacto" className={`${ticketStyles.card} card mt-4 mb-5`}>
      <h1 className={`${ticketStyles.title}`}>Contacto</h1>
      <Grid container className={styles.contactContainer}>
        <Grid item xs={12}>
          <span className={styles.contactValue}>
            Ivan Emmanuel Arredondo Martinez
          </span>
        </Grid>
      </Grid>
      <Grid container className={`${styles.contactContainer} mt-4`}>
        <Grid item xs={12}>
          <span className={styles.contactValue}>
            <Link
              href="https://www.linkedin.com/in/ivanarred"
              target="_blank"
            ...
            <Link
              href="https://github.com/IvanEmAr34"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.contactIconButton}
            >
